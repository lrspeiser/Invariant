...
| 22 | Nonlinear second-variation coverage | Exact cross-direction replay sealed 5,082 additional off-diagonal entries per candidate. Coverage remains 5,324 of 257,499 ordered D2F entries per candidate (60,984 new candidate-bound records globally); 252,175 remain per candidate. A new audit shows that 22 formal direction records represent only 20 unique coordinate vectors. It constructs the entire 133-vector complement for all 12 candidates—1,596 exact tangent certificates in 96 chained checkpoints—so all 153 unique coordinate directions are now sealed. | Coordinate-basis coverage is complete, but no tangent certificate is misbooked as a covariant D2 entry. The next blocker is the physical coordinate-to-covariant projection plus reconciliation of the 22 formal slots with 20 unique vectors. |
