...
2. Register the remaining 195 coordinate-free recurrence packets (45 higher P55,
   45 higher K55, 45 higher TC2, and 60 lower-Sylvester), emit the 117,180 exact
...
4. Materialize the remaining 1,010 general gauge-map scalar values and common domain,
   close the 96 physical gravity rows and sourced constraint propagation, then address
