...
| 41 | Release hygiene | The Goal 25/26 release boundary contains 72 exact paths and about 5.4 MB of new ordinary-Git content. Git LFS tracks 294 historical objects with no object pending upload and no new file large enough to require LFS. Test basetemps, runtime state, and the 115-file D2 checkpoint tree are excluded; 1,939 apparent tracked changes are materializer/line-ending noise. | Stage only the 72 enumerated paths; never bulk-stage this materialized worktree. |
