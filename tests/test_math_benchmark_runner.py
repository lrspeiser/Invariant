...
def test_only_two_validated_controls_are_ready_and_198_are_explicitly_missing(
    ...
    assert metrics["coverage"] == {"coverage_numerator": 2, "coverage_denominator": 200}
    ...
    assert status_counts == {"missing": 198, "ready": 2}
    assert all(
