...
def _validate_gravity_evidence(evidence: Mapping[str, Mapping[str, Any]]) -> None:
    ...
    quadrature_taylor = evidence["shared_quadrature_scalar_exact_taylor_domain"]
    ...
    if (
        ...
        raise ResearchPublicationReadinessError("formula kinetic reconstruction evidence changed")
    if (
...
def build_receipt(root: Path) -> dict[str, Any]:
    ...
    body = {
        ...
        "automatic_findings": {
            ...
            "shared_formula_classes_structurally_mapped_to_minimal_scalar_theory": 60,
            "shared_formula_source_only_minimal_scalar_classes": 3,
            "shared_formula_full_covariant_bridge_derived": False,
            "shared_quadrature_restricted_action_defined": True,
            ...
            "shared_quadrature_universal_vector_metric_defined": True,
            "shared_quadrature_leading_motion_lensing_relation_matched": True,
            ...
            "shared_quadrature_scalar_cherenkov_phase_space_established": True,
            "shared_quadrature_ultrarelativistic_scalar_source_nondecoupling_established": True,
            "shared_quadrature_scalar_cherenkov_rate_derived": True,
