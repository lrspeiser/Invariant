...
def build_receipt(root: Path) -> dict[str, Any]:
    ...
    body = {
        ...
        "matter_lensing_theory_boundary": {
            ...
            "quadrature_reduced_factorization_decision": quadrature_factorization["decision"],
            "quadrature_reduced_six_mode_factorization": quadrature_factorization["adjudication"][
                "restricted_reduced_physical_principal_factorization_established"
            ],
            "quadrature_reduced_six_mode_local_causality": quadrature_factorization["adjudication"][
                "finite_locus_six_reduced_modes_causal_relative_to_physical_photons"
            ],
            "quadrature_reduced_principal_scalar_mixing_present": quadrature_factorization[
                "adjudication"
            ]["static_W_zero_scalar_to_aether_metric_principal_mixing_present"],
            "quadrature_reduced_nonzero_W_factorization": quadrature_factorization["adjudication"][
                "nonzero_W_or_varying_background_factorization_established"
            ],
            "quadrature_reduced_unreduced_constraint_hyperbolicity": quadrature_factorization[
                "adjudication"
            ]["unreduced_gauge_constraint_system_strongly_hyperbolic"],
            ...
            "quadrature_cherenkov_cutoff_rate_decision": quadrature_cherenkov_rate["decision"],
            "quadrature_cherenkov_restricted_stationary_rate_derived": quadrature_cherenkov_rate[
                "adjudication"
            ]["restricted_stationary_cutoff_dependent_radiation_rate_derived"],
            "quadrature_cherenkov_conditional_cutoff_bound_derived": quadrature_cherenkov_rate[
                "adjudication"
            ]["exact_conditional_cutoff_survival_inequality_derived"],
            "quadrature_cherenkov_physical_cutoff_established": quadrature_cherenkov_rate[
                "adjudication"
            ]["physical_UV_cutoff_established"],
            "quadrature_cherenkov_formation_recoil_rate_derived": quadrature_cherenkov_rate[
                "adjudication"
            ]["finite_formation_and_recoil_rate_derived"],
            "quadrature_cherenkov_background_established": quadrature_cherenkov_rate[
                "adjudication"
            ]["on_shell_propagation_background_established"],
            "quadrature_cherenkov_survival_passed": quadrature_cherenkov_rate["adjudication"][
                "cosmic_ray_survival_test_passed"
            ],
            ...
            "quadrature_full_local_decision": quadrature_full_local["decision"],
            "quadrature_full_local_scalar_quartic_expansion": quadrature_full_local["adjudication"][
                "fixed_metric_aether_full_scalar_expansion_through_quartic"
            ],
            "quadrature_full_local_new_interactions_canonicalized": quadrature_full_local[
                "adjudication"
            ]["new_conformal_factor_interactions_canonically_normalized"],
            "quadrature_full_local_derivative_endpoint_limiter": quadrature_full_local[
                "adjudication"
            ]["derivative_scale_remains_low_s_asymptotic_limiter"]
            and quadrature_full_local["adjudication"][
                "derivative_scale_remains_high_s_asymptotic_limiter"
            ],
            "quadrature_full_local_coupled_action": quadrature_full_local["adjudication"][
                "full_coupled_metric_aether_matter_fluctuation_action"
            ],
            "quadrature_full_local_physical_cutoff": quadrature_full_local["adjudication"][
                "physical_UV_cutoff_established"
            ],
        ...
        "limitations": sorted(
            {
                ...
                *map(str, numerical["limitations"]),
                ...
                "Restoring the undifferentiated scalar conformal-factor vertices completes the fixed-metric, fixed-aether scalar Taylor expansion through quartic order, but the derivative coefficient scale still limits both endpoints; metric, aether, matter, unitarity, loops, a physical cutoff, and observation remain outside the result.",
                ...
                "The static-branch reduced-principal successor factors one scalar mode from the five already reduced aether modes and finds all six locally causal on the finite locus, but retains lower-order mixing and does not establish the unreduced constraints, nonzero-W or varying backgrounds, a uniform cutoff, a healthy action, or any physical gate.",
            }
        ),
        "counts": {
            ...
            "quadrature_reduced_factorization_symbolic_checks_passed": quadrature_factorization[
                "counts"
            ]["symbolic_checks_passed"],
            ...
            "quadrature_cherenkov_cutoff_rate_symbolic_checks_passed": quadrature_cherenkov_rate[
                "counts"
            ]["symbolic_checks_passed"],
            ...
            "quadrature_full_local_symbolic_checks_passed": quadrature_full_local["counts"][
                "symbolic_checks_passed"
            ],
