...
from .anonymous_massive_vector_chronological_rediscovery import (
    validate_result as validate_anonymous_massive_vector_rediscovery,
)
...
from .quartic_candidate_pother_one_form_connection_gate import (
    _validate_result as validate_candidate_pother_one_form_connection,
)
...
from .quartic_tc2_d4_revised_eleven_frame_degree_six_envelope_gate import (
    validate_campaign as validate_revised_eleven_frame_degree_six_envelope,
)
from .quartic_tc2_d4_revised_eleven_frame_rational_counterexample_campaign import (
    validate_campaign as validate_revised_eleven_frame_rational_counterexample,
)
from .quartic_tc2_d4_revised_nine_frame_rational_counterexample_campaign import (
    validate_campaign as validate_revised_nine_frame_rational_counterexample,
)
...
def build_unified_snapshot(
    ...
    *,
    ...
    continuous_scientific_pipeline_epoch_003_candidate_followup = sources[
    ...
    continuous_scientific_pipeline_epoch_003_cumulative_formal_partition_0004 = sources[
        "continuous_scientific_pipeline_epoch_003_cumulative_formal_partition_0004"
    ]
    continuous_scientific_pipeline_epoch_003_cumulative_formal_partition_0005 = sources[
        "continuous_scientific_pipeline_epoch_003_cumulative_formal_partition_0005"
    ]
    continuous_scientific_pipeline_epoch_003_cumulative_formal_partition_0006 = sources[
    ...
    anonymous_massive_vector_rediscovery = sources[
    ...
    validate_anonymous_massive_vector_rediscovery(
        anonymous_massive_vector_rediscovery,
    ...
    quartic_tc2_d4_revised_nine_frame_counterexample = sources[
        "quartic_tc2_d4_revised_nine_frame_rational_counterexample"
    ]
    quartic_tc2_d4_revised_ten_frame_counterexample = sources[
        "quartic_tc2_d4_revised_ten_frame_rational_counterexample"
    ]
    quartic_tc2_d4_revised_eleven_frame_counterexample = sources[
    ...
    if (
        ...
        != source_specs["continuous_scientific_pipeline_epoch_003_cumulative_formal_partition_0006"]
    ):
    ...
    validate_revised_nine_frame_rational_counterexample(
        quartic_tc2_d4_revised_nine_frame_counterexample
    )
    ...
    revised_counts = quartic_tc2_d4_revised_symbol_counterexample["counts"]
    revised_gate = quartic_tc2_d4_revised_symbol_counterexample["exact_gate"]
    revised_bindings = quartic_tc2_d4_revised_symbol_counterexample["source_bindings"]
    if (
        quartic_tc2_d4_revised_symbol_counterexample["config_sha256"]
        != "ee01bc5b5ec7c85d0821657797f3c9359a2c6914909a643a679a31afd53fc111"
        or hashlib.sha256(
            (validation_config_root / revised_bindings["campaign_source"]["path"]).read_bytes()
        ).hexdigest()
        != "fbc84b9ad701a6e4e3f0e2bd48a84bc3b695037e0520e915f6605390ed83d528"
        or hashlib.sha256(
            (validation_config_root / revised_bindings["campaign_test"]["path"]).read_bytes()
        ).hexdigest()
        != "d26569da92a734aef323b54499905c87046110b483140987564b83083403518c"
        or revised_bindings["degree_five_predecessor"]
        != {
            "path": source_specs["quartic_tc2_d4_degree_five_counterexample_escape"]["path"],
            "file_sha256": source_specs["quartic_tc2_d4_degree_five_counterexample_escape"][
                "file_sha256"
            ],
            "content_sha256": source_specs["quartic_tc2_d4_degree_five_counterexample_escape"][
                "content_sha256"
            ],
        }
        or _sha(revised_gate) != "181ddfcdf1786c20ff6497e3141969f677a2b08cffeaceb6b1e3ca9e3ab36212"
        or revised_counts["candidate_obstructions"] != 12
        or revised_counts["new_local_candidate_compatibilities"] != 12
        or revised_counts["total_local_direction_certificates"] != 8
    ...
    revised_eight_bindings = quartic_tc2_d4_revised_eight_frame_counterexample["source_bindings"]
    ...
    if (
        ...
        or hashlib.sha256(
            (validation_config_root / revised_eight_bindings["campaign_test"]["path"]).read_bytes()
        ).hexdigest()
        != "08b029fae3dfa010e93e66b28c5efa45a11991da1cb781cc72394e95b851b9ce"
        or revised_eight_bindings["revised_predecessor"]
        != {
            "path": source_specs["quartic_tc2_d4_revised_symbol_rational_counterexample"]["path"],
            "file_sha256": source_specs["quartic_tc2_d4_revised_symbol_rational_counterexample"][
                "file_sha256"
            ],
            "content_sha256": source_specs["quartic_tc2_d4_revised_symbol_rational_counterexample"][
                "content_sha256"
            ],
        }
    ...
    revised_nine_counts = quartic_tc2_d4_revised_nine_frame_counterexample["counts"]
    revised_nine_gate = quartic_tc2_d4_revised_nine_frame_counterexample["exact_gate"]
    revised_nine_bindings = quartic_tc2_d4_revised_nine_frame_counterexample["source_bindings"]
    revised_nine_config_path = validation_config_root / (
        "configs/backgrounds/quartic_tc2_d4_revised_nine_frame_"
        "rational_counterexample_campaign.json"
    )
    revised_nine_config = json.loads(revised_nine_config_path.read_text(encoding="utf-8"))
    if (
        hashlib.sha256(revised_nine_config_path.read_bytes()).hexdigest()
        != "c839232d5028dbafeac95fc6f62ea85de10e245dab8d6eaf286411f8032e1398"
        or revised_nine_config.get("content_sha256")
        != "f42f6bac81f79a60e9104434a50f0359a6ec6c68cb152ab34f75de6922dc1175"
        or quartic_tc2_d4_revised_nine_frame_counterexample["config_sha256"]
        != "f42f6bac81f79a60e9104434a50f0359a6ec6c68cb152ab34f75de6922dc1175"
        or hashlib.sha256(
            (validation_config_root / revised_nine_bindings["campaign_source"]["path"]).read_bytes()
        ).hexdigest()
        != "463cacce692c1241d37010f88be903a0beceee2735db90172f1f899cb46670fc"
        or hashlib.sha256(
            (validation_config_root / revised_nine_bindings["campaign_test"]["path"]).read_bytes()
        ).hexdigest()
        != "bb630e1314ccc11406d97637249d235feda98e402452fa940e28ac0716fffa07"
        or revised_nine_bindings["nine_frame_predecessor"]
        != source_specs["quartic_tc2_d4_revised_eight_frame_rational_counterexample"]
        or _sha(revised_nine_gate)
        != "d393b2c2f9968fcea094cd1125d5124aa78a7dd5a89339afabd1f9e91c545d4c"
        or revised_nine_counts["candidate_obstructions"] != 12
        or revised_nine_counts["new_local_candidate_compatibilities"] != 12
        or revised_nine_counts["total_local_direction_certificates"] != 10
        or revised_nine_counts["inferred_global_passes"] != 0
    ):
        raise ValueError("quartic TC2 revised-nine-frame counterexample is inconsistent")
    validate_revised_ten_frame_rational_counterexample(
        quartic_tc2_d4_revised_ten_frame_counterexample
    )
    revised_ten_counts = quartic_tc2_d4_revised_ten_frame_counterexample["counts"]
    revised_ten_gate = quartic_tc2_d4_revised_ten_frame_counterexample["exact_gate"]
    revised_ten_bindings = quartic_tc2_d4_revised_ten_frame_counterexample["source_bindings"]
    revised_ten_config_path = validation_config_root / (
        "configs/backgrounds/quartic_tc2_d4_revised_ten_frame_rational_counterexample_campaign.json"
    )
    revised_ten_config = json.loads(revised_ten_config_path.read_text(encoding="utf-8"))
    if (
        hashlib.sha256(revised_ten_config_path.read_bytes()).hexdigest()
        != "8afc5b68d8677d9e45197c7aa62f84a7af4285f8976ca1b1d409f3a82e6f8608"
        or revised_ten_config.get("content_sha256")
        != "1e5aa2cd610e6153b32762495819edaff5260b9c7e841fd2fb73111ff328becf"
        or quartic_tc2_d4_revised_ten_frame_counterexample["config_sha256"]
        != "1e5aa2cd610e6153b32762495819edaff5260b9c7e841fd2fb73111ff328becf"
        or hashlib.sha256(
            (validation_config_root / revised_ten_bindings["campaign_source"]["path"]).read_bytes()
        ).hexdigest()
        != "9c02fe156f8d133bd430004d92229291be4765a09a53bef589d9bbffa871dff7"
        or hashlib.sha256(
            (validation_config_root / revised_ten_bindings["campaign_test"]["path"]).read_bytes()
        ).hexdigest()
        != "edf5c845cd75873de83f4e5c8ea65dddea5c525b7c6cdced7f694a964f8e378e"
        or revised_ten_bindings["ten_frame_predecessor"]
        != source_specs["quartic_tc2_d4_revised_nine_frame_rational_counterexample"]
        or _sha(revised_ten_gate)
        != "172cf7a3d659fad3158e6ecc0f0685c5d99a091e486fc29f80e7fbb33ad015ad"
        or revised_ten_counts["candidate_obstructions"] != 12
        or revised_ten_counts["new_local_candidate_compatibilities"] != 12
        or revised_ten_counts["total_local_direction_certificates"] != 11
        or revised_ten_counts["inferred_global_passes"] != 0
    ):
        raise ValueError("quartic TC2 revised-ten-frame counterexample is inconsistent")
    validate_revised_eleven_frame_rational_counterexample(
        quartic_tc2_d4_revised_eleven_frame_counterexample
    )
    revised_eleven_counts = quartic_tc2_d4_revised_eleven_frame_counterexample["counts"]
    revised_eleven_gate = quartic_tc2_d4_revised_eleven_frame_counterexample["exact_gate"]
    revised_eleven_bindings = quartic_tc2_d4_revised_eleven_frame_counterexample["source_bindings"]
    revised_eleven_config_path = validation_config_root / (
        "configs/backgrounds/quartic_tc2_d4_revised_eleven_frame_"
        "rational_counterexample_campaign.json"
    )
    revised_eleven_config = json.loads(revised_eleven_config_path.read_text(encoding="utf-8"))
    if (
        hashlib.sha256(revised_eleven_config_path.read_bytes()).hexdigest()
        != "dd0b2d3448b2734ee6dd98350f0eac2d9d5f45ec0abeea47dfbcea2528534045"
        or revised_eleven_config.get("content_sha256")
        != "1958f5f89d1cafeb5a8b647393e4ba625e4e0e2b0444b019f9f6ae66ad1d275c"
        or quartic_tc2_d4_revised_eleven_frame_counterexample["config_sha256"]
        != "1958f5f89d1cafeb5a8b647393e4ba625e4e0e2b0444b019f9f6ae66ad1d275c"
        or hashlib.sha256(
            (
                validation_config_root / revised_eleven_bindings["campaign_source"]["path"]
            ).read_bytes()
        ).hexdigest()
        != "ff846e3c7b9412003ce628f84383acc2e859559f23025f407e74365ea03dd476"
        or hashlib.sha256(
            (validation_config_root / revised_eleven_bindings["campaign_test"]["path"]).read_bytes()
        ).hexdigest()
        != "6d92015c6187cc7fe4907666c3a383844d1691589c80bad8646fc559852b8dc4"
        or revised_eleven_bindings["eleven_frame_predecessor"]
        != source_specs["quartic_tc2_d4_revised_ten_frame_rational_counterexample"]
        or _sha(revised_eleven_gate)
        != "9f9eec94db2487b1254189882b28c3d2038ff8dfe45b7f2a5b3149881a7d9e36"
        or revised_eleven_counts["candidate_obstructions"] != 12
        or revised_eleven_counts["candidate_compatibilities"] != 0
        or revised_eleven_counts["new_local_direction_certificates"] != 0
        or revised_eleven_counts["total_local_direction_certificates"] != 11
        or revised_eleven_counts["bounded_envelope_supports_checked"] != 32_766
        or revised_eleven_counts["feasible_preserving_envelopes"] != 0
        or revised_eleven_counts["inferred_global_passes"] != 0
    ):
        raise ValueError("quartic TC2 revised-eleven-frame counterexample is inconsistent")
    validate_revised_eleven_frame_degree_six_envelope(
        quartic_tc2_d4_revised_eleven_frame_degree_six_envelope
    )
    degree_six_counts = quartic_tc2_d4_revised_eleven_frame_degree_six_envelope["counts"]
    degree_six_gate = quartic_tc2_d4_revised_eleven_frame_degree_six_envelope["exact_gate"]
    degree_six_bindings = quartic_tc2_d4_revised_eleven_frame_degree_six_envelope["source_bindings"]
    degree_six_config_path = validation_config_root / (
        "configs/backgrounds/quartic_tc2_d4_revised_eleven_frame_degree_six_envelope_gate.json"
    )
    degree_six_config = json.loads(degree_six_config_path.read_text(encoding="utf-8"))
    if (
        hashlib.sha256(degree_six_config_path.read_bytes()).hexdigest()
        != "e92347af9109b78da76880ea7cf225541e1b166845843e9ec2c2d6c00c0d2287"
        or degree_six_config.get("content_sha256")
        != "8b212698a11f5963f8f82acf66e30364a4bbf8622c177856798d8701d85aa6dc"
        or quartic_tc2_d4_revised_eleven_frame_degree_six_envelope["config_sha256"]
        != "8b212698a11f5963f8f82acf66e30364a4bbf8622c177856798d8701d85aa6dc"
        or hashlib.sha256(
            (validation_config_root / degree_six_bindings["campaign_source"]["path"]).read_bytes()
        ).hexdigest()
        != "50a2cdea20ed9614e8bfcc37d821aa48a97916af323e05d466c218e3aaf679d2"
        or hashlib.sha256(
            (validation_config_root / degree_six_bindings["campaign_test"]["path"]).read_bytes()
        ).hexdigest()
        != "7c5e581e3325d1ce4aab77178fb72cf1885348f712b6a57c4e6baf5019679d86"
        or degree_six_bindings["exhaustion_predecessor"]
        != source_specs["quartic_tc2_d4_revised_eleven_frame_rational_counterexample"]
        or _sha(degree_six_gate)
        != "962c4014df740b9ac117a9c344354b73b6d36d74e09fd003625874c63f1f0a0d"
        or degree_six_counts["candidate_obstructions"] != 12
        or degree_six_counts["new_local_direction_certificates"] != 1
        or degree_six_counts["total_local_direction_certificates"] != 12
    ...
    def compact_revised_gate(gate: Mapping[str, Any]) -> dict[str, Any]:
        """Project exact summaries after the full source artifact has validated."""
        obstruction = gate["first_obstruction"]
        escape = gate["bounded_next_escape"]
        exact_obstruction = {
            key: value
            for key, value in obstruction["exact_rational_obstruction"].items()
            if key != "candidate_records"
        }
        local_completion = {
            key: value
            for key, value in escape["local_completion"].items()
            if key != "candidate_records"
        }
        return {
            "atlas": gate["atlas"],
            "search_protocol": gate["search_protocol"],
            "first_obstruction": {
                "selector": obstruction["selector"],
                "full_recurrence": obstruction["full_recurrence"],
                "exact_rational_obstruction": exact_obstruction,
            },
            "bounded_next_escape": {
                "exact_range_classification": escape["exact_range_classification"],
                "minimal_preserving_envelope": escape["minimal_preserving_envelope"],
                "local_completion": local_completion,
            },
        }

    revised_symbol_projection = compact_revised_gate(
        quartic_tc2_d4_revised_symbol_counterexample["exact_gate"]
    )
    revised_eight_projection = compact_revised_gate(revised_eight_gate)
    revised_nine_projection = compact_revised_gate(revised_nine_gate)
    revised_ten_projection = compact_revised_gate(revised_ten_gate)
    revised_eleven_obstruction = revised_eleven_gate["first_obstruction"]
    revised_eleven_escape = revised_eleven_gate["bounded_next_escape"]
    revised_eleven_projection = {
        "atlas": revised_eleven_gate["atlas"],
        "search_protocol": revised_eleven_gate["search_protocol"],
        "first_obstruction": {
            "selector": revised_eleven_obstruction["selector"],
            "full_recurrence": revised_eleven_obstruction["full_recurrence"],
            "exact_rational_obstruction": {
                key: value
                for key, value in revised_eleven_obstruction["exact_rational_obstruction"].items()
                if key != "candidate_records"
            },
        },
        "bounded_next_escape": {
            "exact_range_classification": revised_eleven_escape["exact_range_classification"],
            "minimal_preserving_envelope": revised_eleven_escape["minimal_preserving_envelope"],
            "bounded_repair_classification": revised_eleven_escape["bounded_repair_classification"],
        },
    }
    ...
    core = {
        ...
        "continuous_scientific_pipeline_epoch_003_genesis": {
            "decision": continuous_scientific_pipeline_epoch_003_genesis["decision"],
            "epoch_id": continuous_scientific_pipeline_epoch_003_genesis["epoch_id"],
            "predecessor_stop_ordinal_exclusive": continuous_scientific_pipeline_epoch_003_genesis[
                "predecessor"
            ]["stop_ordinal_exclusive"],
            "coverage": {
                key: value
                for key, value in continuous_scientific_pipeline_epoch_003_genesis[
                    "coverage"
                ].items()
                if key != "intervals"
            },
            "persistent_resume_ready": all(
                continuous_scientific_pipeline_epoch_003_genesis["resume_contract"].values()
            ),
            "execution_state": continuous_scientific_pipeline_epoch_003_genesis["execution_state"],
            "promotion_admitted": any(
                continuous_scientific_pipeline_epoch_003_genesis["promotion_contract"].values()
            ),
            "excluded_state_seals_closed": not any(
                continuous_scientific_pipeline_epoch_003_genesis["seals"].values()
            ),
        },
        "continuous_scientific_pipeline_epoch_003_result": {
        ...
        "continuous_scientific_pipeline_epoch_003_candidate_followup": {
            ...
            "decision": continuous_scientific_pipeline_epoch_003_candidate_followup["decision"],
            "source_pass_batch_indices": continuous_scientific_pipeline_epoch_003_candidate_followup[
                "source_pass_batch_indices"
            ],
            "counts": continuous_scientific_pipeline_epoch_003_candidate_followup["counts"],
            "candidate_decision_records_root_sha256": (
                continuous_scientific_pipeline_epoch_003_candidate_followup[
                    "candidate_decision_records_root_sha256"
                ]
            ),
            "first_remaining_blocker": continuous_scientific_pipeline_epoch_003_candidate_followup[
                "first_remaining_blocker"
            ],
            ...
            "excluded_state_seals_closed": not any(
                continuous_scientific_pipeline_epoch_003_candidate_followup["seals"].values()
            ),
        },
        "continuous_scientific_pipeline_epoch_003_survivor_pagination": {
            "artifact_binding": source_specs[
            ...
            "decision": continuous_scientific_pipeline_epoch_003_survivor_pagination["decision"],
            "counts": continuous_scientific_pipeline_epoch_003_survivor_pagination["counts"],
            "ordered_batch_content_root_sha256": (
                continuous_scientific_pipeline_epoch_003_survivor_pagination[
                    "ordered_batch_content_root_sha256"
                ]
            ),
            ...
            "complete_formal_receipts": continuous_scientific_pipeline_epoch_003_survivor_pagination[
            ...
            "excluded_state_seals_closed": not any(
                continuous_scientific_pipeline_epoch_003_survivor_pagination["seals"].values()
            ),
        },
        "continuous_scientific_pipeline_epoch_003_formal_receipt_worker_partition_0001": {
            "artifact_binding": source_specs[
        ...
        "formal_receipt_cursor": {
            ...
            "counts": {
                ...
                for key in (
                    "processed_partition_prefix_length",
                    "cumulative_formally_checked_candidates",
                    "cumulative_newly_processed_candidates",
                    "cumulative_reconciled_preserved_candidates",
                    "cumulative_candidate_rejects",
                    "remaining_pending_formal_receipts",
                )
            },
            "roots": {
        ...
        "anonymous_massive_vector_chronological_rediscovery": {
            "artifact_binding": source_specs["anonymous_massive_vector_chronological_rediscovery"],
            "decision": anonymous_massive_vector_rediscovery["decision"],
            "enumeration": anonymous_massive_vector_rediscovery["enumeration"],
            "pre_unseal_io": {
                key: anonymous_massive_vector_rediscovery["pre_unseal_phase_io_contract"][key]
                for key in (
                    "attempted_access_count",
                    "allowed_access_count",
                    "denied_access_count",
                    "denied_content_bytes_exposed",
                    "allowed_paths",
                    "denied_paths",
                    "enforcement_surfaces",
                    "enforcement_scope",
                    "single_threaded_phase",
                )
            }
            | {
                "contract_root_sha256": anonymous_massive_vector_rediscovery["chronology"][1][
                    "root_sha256"
                ]
            },
            "leakage_audit": {
                key: anonymous_massive_vector_rediscovery["pre_unseal_leakage_audit"][key]
                for key in (
                    "bytes_scanned",
                    "forbidden_concept_count",
                    "unexpected_import_roots",
                    "pre_unseal_dependency_paths",
                    "pre_unseal_dependency_root_sha256",
                    "passed",
                )
            },
            "blinded_ranking": {
                "eligible_candidate_count": anonymous_massive_vector_rediscovery[
                    "blinded_pareto_ranking"
                ]["eligible_candidate_count"],
                "pareto_front_size": anonymous_massive_vector_rediscovery["blinded_pareto_ranking"][
                    "pareto_front_size"
                ],
                "pareto_root_sha256": anonymous_massive_vector_rediscovery[
                    "blinded_pareto_ranking"
                ]["pareto_root_sha256"],
                "blinded_pre_unseal_root_sha256": anonymous_massive_vector_rediscovery[
                    "blinded_pre_unseal_root_sha256"
                ],
                "coefficient_visibility_before_unseal": anonymous_massive_vector_rediscovery[
                    "blinded_pareto_ranking"
                ]["coefficient_visibility_before_unseal"],
            },
            "post_unseal": {
                key: anonymous_massive_vector_rediscovery["unsealed_result"][key]
                for key in (
                    "eligible_positive_mass_representatives",
                    "canonical_representative",
                    "independent_euler_derivation",
                    "independent_divergence_derivation",
                    "canonical_hamiltonian_derivation",
                    "first_class_constraint_count",
            ...
            "negative_controls": anonymous_massive_vector_rediscovery["negative_controls"],
            "chronology": [
                row["phase"] for row in anonymous_massive_vector_rediscovery["chronology"]
            ],
            "true_claims": sorted(
                key
                for key, value in anonymous_massive_vector_rediscovery["claims"].items()
                if value
            ),
            "false_claims": sorted(
                key
            ...
            "first_remaining_blocker": anonymous_massive_vector_rediscovery[
                "first_remaining_blocker"
            ],
        },
        "quartic_nonlinear_closure": {
            ...
            "recovery_operator_calculus": {
                ...
                "finite_sobolev_hierarchy_no_go": {
                    ...
                    "true_claims": sorted(
                        key
                        for key, value in quartic_finite_sobolev_no_go["claim_seals"].items()
                        if value
                    ),
                    "all_data_seals_closed": not any(
                        quartic_finite_sobolev_no_go["data_seals"].values()
                    ),
                },
                "full_tensor_good_unknown_reconciliation": {
                    ...
                    "true_claims": sorted(
                        key
                        for key, value in quartic_full_tensor_reconciliation["claim_seals"].items()
                        if value
                    ),
                    "all_data_seals_closed": not any(
                        quartic_full_tensor_reconciliation["data_seals"].values()
                    ),
                },
                    ...
                    "candidate_records": [
                        {
                            ...
                            "failed_ordered_family_pair_count": row["schwarz_integrability"][
                ...
                "scalar_hessian_curl_invariance": {
                    "artifact_binding": source_specs["quartic_scalar_hessian_curl_invariance_gate"],
                    "decision": quartic_scalar_hessian_curl_invariance["decision"],
                    "decision_counts": quartic_scalar_hessian_curl_invariance["decision_counts"],
                    "gate_counts": quartic_scalar_hessian_curl_invariance["gate_counts"],
                    "first_blocker": quartic_scalar_hessian_curl_invariance["first_blocker"],
                    "theorem": quartic_scalar_hessian_curl_invariance["theorem"],
                    "exact_controls": quartic_scalar_hessian_curl_invariance["exact_controls"],
                    "candidate_records": [
                        {
                            "candidate_id": row["candidate_id"],
                            "candidate_decision": row["candidate_decision"],
                            "candidate_rejection_authorized": row["candidate_rejection_authorized"],
                            "registered_naive_chunk_curl_nonzero": row[
                                "registered_naive_chunk_curl_nonzero"
                            ],
                            "coordinate_only_repair_possible": row[
                                "coordinate_only_repair_possible"
                            ],
                            "torsion_free_domain_connection_repair_possible": row[
                                "torsion_free_domain_connection_repair_possible"
                            ],
                            "corrected_source_or_output_bundle_or_torsion_repair_ruled_out": row[
                                "corrected_source_or_output_bundle_or_torsion_repair_ruled_out"
                            ],
                            "ordered_nonzero_pair_count": row["curl_two_form_manifest"][
                                "ordered_nonzero_pair_count"
                            ],
                            "independent_nonzero_pair_count": row["curl_two_form_manifest"][
                                "independent_nonzero_pair_count"
                            ],
                            "ordered_nonzero_component_count": row["curl_two_form_manifest"][
                                "ordered_nonzero_component_count"
                            ],
                            "independent_nonzero_component_count": row["curl_two_form_manifest"][
                                "independent_nonzero_component_count"
                            ],
                        }
                        for row in quartic_scalar_hessian_curl_invariance["candidate_records"]
                    ],
                    "secondary_blockers": quartic_scalar_hessian_curl_invariance[
                        "secondary_blockers"
                    ],
                    "claim_seals": quartic_scalar_hessian_curl_invariance["claim_seals"],
                ...
                "full_d2f_high_atom_coverage": {
                    "artifact_binding": source_specs["quartic_full_d2f_high_atom_coverage_gate"],
                    "decision": quartic_full_d2f_high_atom_coverage["decision"],
                    "decision_counts": quartic_full_d2f_high_atom_coverage["decision_counts"],
                    "gate_counts": quartic_full_d2f_high_atom_coverage["gate_counts"],
                    "pair_status_counts": quartic_full_d2f_high_atom_coverage[
                        "ordered_coverage_ledger"
                    ]["pair_status_counts"],
                    "first_blocker": quartic_full_d2f_high_atom_coverage["first_blocker"],
                ...
                "principal_high_atom_connection_extension": {
                    ...
                    "gate_counts": quartic_principal_high_atom_connection_extension["gate_counts"],
                    "first_blocker": quartic_principal_high_atom_connection_extension[
                        "first_blocker"
                    ],
                    "claim_seals": quartic_principal_high_atom_connection_extension["claim_seals"],
                    "data_seals": quartic_principal_high_atom_connection_extension["data_seals"],
                },
                "reverse_principal_source_map_identifiability": {
                    "artifact_binding": source_specs[
                        "quartic_reverse_principal_source_map_identifiability_gate"
                    ],
                    "decision": quartic_reverse_principal_source_map_identifiability["decision"],
                    "decision_counts": quartic_reverse_principal_source_map_identifiability[
                        "decision_counts"
                    ],
                    "gate_counts": quartic_reverse_principal_source_map_identifiability[
                        "gate_counts"
                    ],
                    "schema_audit": quartic_reverse_principal_source_map_identifiability[
                        "schema_audit"
                    ],
                    "generic_witness": quartic_reverse_principal_source_map_identifiability[
                        "nonidentifiability_theorem"
                    ]["generic_witness"],
                    "first_blocker": quartic_reverse_principal_source_map_identifiability[
                        "first_blocker"
                    ],
                    "claim_seals": quartic_reverse_principal_source_map_identifiability[
                        "claim_seals"
                    ],
                    "data_seals": quartic_reverse_principal_source_map_identifiability[
                        "data_seals"
                    ],
                },
                "reverse_principal_typed_map_curl": {
                    ...
                    "decision_counts": quartic_reverse_principal_typed_map_curl["decision_counts"],
                    ...
                    "first_blocker": quartic_reverse_principal_typed_map_curl["first_blocker"],
                ...
                "cross_slice_one_sided_output_connection_no_go": {
                    "artifact_binding": source_specs[
                        "quartic_cross_slice_one_sided_output_connection_no_go_gate"
                    ],
                    "decision": quartic_cross_slice_one_sided_output_connection_no_go["decision"],
                    "decision_counts": quartic_cross_slice_one_sided_output_connection_no_go[
                        "decision_counts"
                    ],
                    "gate_counts": quartic_cross_slice_one_sided_output_connection_no_go[
                        "gate_counts"
                    ],
                    "no_go_theorem": quartic_cross_slice_one_sided_output_connection_no_go[
                        "no_go_theorem"
                    ],
                    "first_blocker": quartic_cross_slice_one_sided_output_connection_no_go[
                        "first_blocker"
                    ],
                    "claim_seals": quartic_cross_slice_one_sided_output_connection_no_go[
                        "claim_seals"
                    ],
                    "data_seals": quartic_cross_slice_one_sided_output_connection_no_go[
                        "data_seals"
                    ],
                },
                ...
                "candidate_pother_one_form_connection": {
                    ...
                    "decision": quartic_candidate_pother_one_form_connection["decision"],
                    "decision_counts": quartic_candidate_pother_one_form_connection[
                        "decision_counts"
                    ],
                    "gate_counts": {
                        key: quartic_candidate_pother_one_form_connection["gate_counts"][key]
                        for key in (
                            "Pother_one_form_entries_per_candidate",
                            "Pother_one_form_nonzero_entries_per_candidate",
                            "Pother_one_form_rank_per_candidate",
                            "two_sided_equations_per_candidate",
                            "two_sided_connection_unknowns_per_candidate",
                            "two_sided_coefficient_rank_per_candidate",
                            "two_sided_augmented_rank_per_candidate",
                            "two_sided_affine_solution_dimension_per_candidate",
                            "algebraic_connection_nonzero_entries_per_candidate",
                            "algebraic_connection_residual_nonzero_entries",
                            "covariant_action_derived_connections",
                            "cross_slice_entries_admitted",
                            "principal_high_atom_entries_missing_per_candidate",
                        )
                    },
                    "first_blocker": quartic_candidate_pother_one_form_connection["first_blocker"],
                    "true_claims": sorted(
                        key
                        for key, value in quartic_candidate_pother_one_form_connection[
                            "claim_seals"
                        ].items()
                        if value
                    ),
                ...
                "fitted_output_connection_covariant_origin": {
                    ...
                    "all_data_seals_closed": not any(
                        quartic_fitted_output_connection_covariant_origin["data_seals"].values()
                    ),
                },
                ...
                "all_candidate_sets_equal": (
                    ...
                    == [
                        row["candidate_id"]
                        for row in quartic_candidate_pother_one_form_connection["candidate_records"]
                    ]
                    == [
                        row["candidate_id"]
            ...
            "fourth_jet_range_obligations": {
                ...
                "canonical_obstruction_certificate": {
                    ...
                    "revised_symbol_rational_counterexample": {
                        "status": quartic_tc2_d4_revised_symbol_counterexample["status"],
                        "counts": quartic_tc2_d4_revised_symbol_counterexample["counts"],
                        **revised_symbol_projection,
                    ...
                    "revised_nine_frame_rational_counterexample": {
                        "status": quartic_tc2_d4_revised_nine_frame_counterexample["status"],
                        "counts": revised_nine_counts,
                        **revised_nine_projection,
                        "claims": quartic_tc2_d4_revised_nine_frame_counterexample["claims"],
                        "scope": quartic_tc2_d4_revised_nine_frame_counterexample["scope"],
                    },
                    "revised_ten_frame_rational_counterexample": {
                        "status": quartic_tc2_d4_revised_ten_frame_counterexample["status"],
                        "counts": revised_ten_counts,
                        **revised_ten_projection,
                        "claims": quartic_tc2_d4_revised_ten_frame_counterexample["claims"],
                        "scope": quartic_tc2_d4_revised_ten_frame_counterexample["scope"],
                    },
                    "revised_eleven_frame_rational_counterexample": {
                        "status": quartic_tc2_d4_revised_eleven_frame_counterexample["status"],
                        "counts": revised_eleven_counts,
                        **revised_eleven_projection,
                        "claims": quartic_tc2_d4_revised_eleven_frame_counterexample["claims"],
                        "scope": quartic_tc2_d4_revised_eleven_frame_counterexample["scope"],
                    },
                    "revised_eleven_frame_degree_six_envelope": {
                        "status": quartic_tc2_d4_revised_eleven_frame_degree_six_envelope["status"],
                        "counts": degree_six_counts,
                        "atlas": degree_six_gate["atlas"],
                        "search_protocol": degree_six_gate["search_protocol"],
                        "selector": degree_six_gate["selector"],
                        "exact_rational_classification": degree_six_gate[
                            "exact_rational_classification"
                        ],
                        "bounded_classification": degree_six_gate["bounded_classification"],
