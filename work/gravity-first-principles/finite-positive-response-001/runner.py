...
dest=root/'work/gravity-first-principles/finite-positive-response-001'
...
registration=dict(input_sha256={p.name:hashlib.sha256(p.read_bytes()).hexdigest() for p in paths},
    shapes=[.5,1.,2.],plummer_scales=[30.,100.],contrasts=[.01,.1],k_ratios=[.5,2.,8.],sample_counts=[256,512],
