    ...
    try:
        ...
        for variant in source['variants']:
            ...
            for case in config['cases']:
                ...
                corrected, details = complete_leading_tail(near, disks, transform['components'], k, w, S, R, z, G, base['cutoff'], log_nodes=case['log_nodes'], precision=case.get('precision', config.get('precision')))
