...
## Retained exploratory comparison with published motion — not admitted
...
After the source admission package is complete, the next decisive test is whether a source-supported bar/streaming model predicts
