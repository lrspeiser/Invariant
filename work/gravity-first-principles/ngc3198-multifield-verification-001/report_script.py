...
def replay(result, parent, old, maps, refined=False):
...
def main():
    ...
    checks = {'parents': sealed, 'initial': replay(parent, parent, old, maps),
              'refined': replay(refined, parent, old, maps, refined=True)}
...
source's outermost tested radius, 20 kpc, all six auxiliary kernels contribute
