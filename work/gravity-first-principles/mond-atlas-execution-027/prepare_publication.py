...
prior=ROOT/'work/gravity-first-principles/mond-atlas-execution-026/publication-manifest.json'
...
for pattern in ['mond_atlas_external_boundary*.py','mond_atlas_noise_mode_power.py','mond_atlas_selection_ablation*.py','mond_atlas_co_photometry.py']:
...
paths.add(manifest.relative_to(ROOT).as_posix());private=ROOT/'work/private/mond-atlas-execution-027';private.mkdir(exist_ok=False)
