...
D=ROOT/'work/gravity-first-principles/things-observable-acquisition-001'
PRIVATE=ROOT/'work/private/things-observable-12gal-001'
...
for obj in pre['object_source_contracts']:
    for spec in obj['hi_files']:
        for moment in (0,1,2):
            url=spec['url'].replace('MOM0',f'MOM{moment}');assert url in links
