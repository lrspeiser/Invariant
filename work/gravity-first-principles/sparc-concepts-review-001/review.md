# SPARC: existing evidence and initial concepts for review
...
|---|---:|---:|---:|
| Acceleration-only adjustment | 4.26% better | 74/139 | +1.70% |
| Local brightness-gradient adjustment | 4.52% better | 79/139 | +5.97% |
| Signed nonlocal profile correction | 8.18% better | 80/139 | +3.60% |
| Interior matter / exterior vacancy focusing | 18.76% better | 55/139 | -1.43% |

The most eye-catching aggregate result, interior/exterior focusing, improves only 55 galaxies. UGC02953 supplies 74.4% of its net improvement. Removing that galaxy changes the aggregate improvement to 5.83%. This is an influence diagnostic, not a reason to discard the galaxy. Its source mass model, inclination, distance, and uncertainty model deserve inspection alongside other successes and failures. The median galaxy is slightly worse. Therefore the record does not establish a broadly successful extra-attraction law.
