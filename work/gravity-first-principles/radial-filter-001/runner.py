...
dest = root / 'work/gravity-first-principles/radial-filter-001'
...
result = dict(registration=registration, rows=rows, worst_absolute_error=worst,
              passed=worst < registration['absolute_error_threshold_normalized_fields'],
...
Evidence: radial-filter-001/result.json; SHA-256 {digest}.
'''
