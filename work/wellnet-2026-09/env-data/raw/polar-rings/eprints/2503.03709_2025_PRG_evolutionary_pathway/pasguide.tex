...
\author{\sn{Cambridge} \gn{Author1}$^{1}$ and \sn{Cambridge} \gn{Author2}$^{2}$}

\affil{$^1$School of Physics, The University of Melbourne, Parkville, VIC 3010, Australia and $^2$ARC Centre of Excellence for All-Sky Astrophysics in 3 Dimensions (ASTRO-3D)}
